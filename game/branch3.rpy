...
label teddy_and_suzuki:
    ...
    scene black
    centered "{cps=20}Teddy jumps from above on the dinosaur boss, immobilizing him. Agent Milton stays in shock and aims his gun at each of them.{/cps}{w=0.5}{nw}"
    ...
    scene cave boss3
    play music "/audio/cave.mp3" volume 4.0
    ...
    scene black
    centered "{cps=20}Teddy leads Suzuki back to the room and orders the guards to stand still and free all capybaras. They were released and told what had happened.{/cps}{w=0.5}{nw}"
    stop music fadeout 1.0
    jump finding_yamaha

label finding_yamaha:
    scene find yamaha
    play music "/audio/romantic.mp3"
    show yamaha shy at right
    yamaha "Suzuki! You are my hero! I feared I would never see you again."
    show suzuki shy at left
    ...
    if love >= 1:
        scene black
        centered "{cps=20}Yamaha and Suzuki went happily on their honeymoon...{/cps}{w=0.5}{nw}"
        scene honey
        pause 2.0
