label first_meet:
    ...
    teddy "Because, my friend, not all dinosaurs share the same goals. I've seen the pain caused by the dinosaur king's actions, and I want to stop it. Yamaha being taken is part of their plan, and we can't let that happen."
    ...
    scene black
    center "{cps=20}Suzuki and Teddy, while infiltrating the dinosaur kingdom, stumble upon a clandestine council of dinosaurs advocating for peace. The player decides how Suzuki reacts to this revelation.{/cps}{w=0.5}{nw}"
